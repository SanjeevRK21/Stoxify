      ...
      <div className="w-full md:w-[55%] relative flex flex-col justify-between p-8 md:p-16 lg:p-24 border-r border-white/5">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl text-muted-foreground max-w-lg leading-relaxed mb-12">
            Aura combines quantitative market metrics with your distinct behavioral footprint to construct highly personalized, high-conviction portfolios.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h4 className="font-bold text-white">Tensor-weighted Scoring</h4>
                <p className="text-sm text-muted-foreground">Advanced normalization of CAGR, volatility & alpha.</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h4 className="font-bold text-white">Behavioral Alignment</h4>
                <p className="text-sm text-muted-foreground">Portfolio constraints driven by your actual risk tolerance.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 mt-20 text-sm text-muted-foreground/60 font-medium">
          © {new Date().getFullYear()} Aura Capital. Institutional grade tooling.
        </div>
      </div>
      ...
      <div className="w-full md:w-[45%] flex items-center justify-center p-8 md:p-16 relative bg-secondary/10">
        <div className="w-full max-w-md space-y-8 relative z-10 glass-card p-10 rounded-3xl">
          <div className="text-center">
            <h2 className="text-3xl font-display font-bold text-white mb-3">Initialize Session</h2>
            <p className="text-muted-foreground">Secure connection via Replit Identity to access your investment profiles.</p>
          </div>
          ...
          <div className="text-center mt-6">
            <p className="text-xs text-muted-foreground">
              By authenticating, you agree to our Terms of Service and Risk Disclosures.
            </p>
          </div>
        </div>
      </div>
