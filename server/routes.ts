  ...
  try {
    ...
    if (allStocks.length === 0) {
      const seedStocks = [
        ...
        { ticker: 'RELIANCE', name: 'Reliance Industries', sector: 'Energy', geography: 'India', price: 2900.0, cagr: 0.18, volatility: 0.22, skewness: -0.1, alpha: 0.04, recoveryTime: 45, normCagr: 0.65, normVolatility: 0.45, normSkewness: 0.5, normAlpha: 0.6, normRecovery: 0.75 },
        { ticker: 'TCS', name: 'Tata Consultancy Services', sector: 'Tech', geography: 'India', price: 4100.0, cagr: 0.15, volatility: 0.18, skewness: 0.0, alpha: 0.03, recoveryTime: 30, normCagr: 0.55, normVolatility: 0.6, normSkewness: 0.6, normAlpha: 0.5, normRecovery: 0.9 },
        { ticker: 'HDFCBANK', name: 'HDFC Bank', sector: 'Finance', geography: 'India', price: 1600.0, cagr: 0.16, volatility: 0.20, skewness: -0.05, alpha: 0.04, recoveryTime: 40, normCagr: 0.6, normVolatility: 0.55, normSkewness: 0.55, normAlpha: 0.6, normRecovery: 0.8 },
        { ticker: 'INFY', name: 'Infosys Ltd.', sector: 'Tech', geography: 'India', price: 1500.0, cagr: 0.14, volatility: 0.24, skewness: -0.1, alpha: 0.03, recoveryTime: 50, normCagr: 0.5, normVolatility: 0.4, normSkewness: 0.5, normAlpha: 0.5, normRecovery: 0.7 },
        { ticker: 'ICICIBANK', name: 'ICICI Bank', sector: 'Finance', geography: 'India', price: 1100.0, cagr: 0.20, volatility: 0.22, skewness: 0.05, alpha: 0.05, recoveryTime: 35, normCagr: 0.7, normVolatility: 0.5, normSkewness: 0.65, normAlpha: 0.7, normRecovery: 0.85 }
